...
const SimilarMovies = ({ id }) => {
  ...
  const similarMovieSelector = useSelector(
  ...
  return (
    <div className="container">
      <h1 className="flex justify-center text-5xl">Similar Movies</h1>
      <div className="flex overflow-hidden">
        ...
        >
          {similarMovieSelector.filter((fm) => fm.poster_path).map((movie) => (
            <SwiperSlide key={movie.id}>
              <div className="m-5 mx-3 relative text-xs flex w-full max-w-[23rem] flex-col rounded-lg  shadow-lg">
                <div className="upcoming-poster relative mx-4 mt-1 overflow-hidden shadow-lg rounded-sm bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                  <img
