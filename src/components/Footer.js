...
const Footer = () => {
  ...
  return (
    <div className={`px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  ${darkTheme && 'bg-gradient-to-b from-slate-800 overflow-hidden'}`}>
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <div className="inline-flex items-center">
            ...
            >
              <g transform="matrix(1,0,0,1,-0.9090909090909918,-0.10336603773703246)">
                <svg
                  viewBox="0 0 396 86"
                ...
                >
                  <g
                    id="tight-bounds"
                    transform="matrix(1,0,0,1,0.2400000000000091,0.027352243831956002)"
                  >
                    <svg
                      viewBox="0 0 395.52 85.94529551233607"
                      height="85.94529551233607"
                      width="395.52"
                    >
                      <g>
                        <svg
                          viewBox="0 0 530.4835339257104 115.2724617912458"
                          height="85.94529551233607"
                          width="395.52"
                        >
                          <g transform="matrix(1,0,0,1,0,15.931288134680138)">
                            <svg
                              viewBox="0 0 395.52 83.40988552188553"
                              height="83.40988552188553"
                              width="395.52"
                            >
                          ...
                          <g transform="matrix(1,0,0,1,415.21107213446464,0)">
                            <svg
                              viewBox="0 0 115.2724617912458 115.2724617912458"
                              height="115.2724617912458"
                              width="115.2724617912458"
                            >
                              <g data-palette-color="#ff7e1b">
                                <rect
                                  width="31.50780622294052"
                                  height="115.2724617912458"
                                  fill="#ff7e1b"
                                  stroke="transparent"
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm ">
              Streamify is your go-to destination for comprehensive movie
              details, release dates, and popularity trends. Explore and
              discover everything you need to know about your favorite films,
              all in one place.
            </p>
            <p className="mt-4 text-sm ">
              This website is intended for informational purposes only. It
              provides knowledge and insights to enhance your understanding and
              awareness.
            </p>
          </div>
        </div>
            ...
            <div className="col mb-5">
              ...
              <div className="flex">
                ...
                <a
                  ...
                  className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
                >
                  Siddhatek Nagar Nashik, 422010
                </a>
              </div>
            </div>
            <div className="col">
              <p className="text-base font-bold tracking-wide ">Social Media</p>
        ...
        <div className="relative space-y-2 max-h-72 text-sm">
          <Favorites />
        </div>
      </div>
      <hr className="text-black" style={{ zIndex: "0", width: "77%" }} />
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 lg:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2024 Streamify. All rights reserved.
        </p>
      </div>
    </div>
  );
